...
// Used to identify domains within a SINGLE core.
typedef uint32_t local_domainid_t;

/* Domain ID */
// 32 ------- 24 -------- 16 -------- 8 -------- 0
//   coreid_t  |        local_domainid_t
typedef uint32_t domainid_t;
#    define MAX_DOMAINID 0xffffffff
#    define PRIuDOMAINID PRIu32
#    define PRIxDOMAINID PRIx32

// Used to identify services within a SINGLE domain.
typedef uint32_t local_serviceid_t;

// Used to identify services globally, across cores and domains.
// 64 ------- 56 ------- 48 ------- 40 ------- 32 ------- 24 -------- 16 -------- 8
// -------- 0
//                 domainid_t                   |               local_serviceid_t
