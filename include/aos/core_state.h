...
struct core_state_generic {
    ...
    // contains channels to other cores
    struct aos_rpc *core_client_rpcs[MAX_COREID];
    struct aos_rpc *core_server_rpcs[MAX_COREID];
    struct platform_info platform_info;
    struct nameservice_chan *nameserver_chan;
    bool is_nameserver_started;
