...
extern struct capref cap_root, cap_monitorep, cap_irq, cap_io, cap_dispatcher, cap_selfep,
    cap_kernel, cap_initep, cap_memep, cap_urpc, cap_perfmon, cap_dispframe,
    cap_sessionid, cap_ipi, cap_vroot, cap_argcn, task_cap_argcn0, task_cap_argcn1,
    task_cap_argcn2, cap_procmng, cap_domainid, cap_bootinfo, cap_mmstrings;
