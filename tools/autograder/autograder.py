...
CFG_LOCAL_BOOT_CMD = "usbboot_imx8x"
...
# sudo UUU=~/Documents/os/bin/uuu python3 autograder.py  -t mm:Malloc-Small:Malloc-Medium -v
# autograder.py  -t mm:Malloc-Small:Malloc-Medium -v